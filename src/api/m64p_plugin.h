...
typedef void (*ptr_AddHiresTexturePath)(const char* path); // Texture exports for modloader
...
EXPORT void CALL AddHiresTexturePath(char* path); // Texture exports for modloader
